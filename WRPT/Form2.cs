...
namespace WRPT
{
    public partial class Form2 : Form
    {
        ...
        {
            int index = e.RowIndex + M1;
            int yind = index / 12;
            if (index >= 12 * yind) { index = index - 12 * yind; }
            //Debug.WriteLine("e.index+M1={0}, index={1}, yind={2}", e.RowIndex + M1, index, yind);
