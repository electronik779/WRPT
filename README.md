...
Установка не требуется. Для Windows x64 скачайте файл WRPT_2025.1.exe из раздела Releases (WRPT для Windows x64) в любую удобную для вас папку и запустите.
