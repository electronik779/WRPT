...
Установка не требуется. Для Windows x64 скачайте "свежий" релиз ([WRPT для Windows x64](https://github.com/electronik779/WRPT/releases)), распакуйте в любую удобную для вас папку и запустите.
